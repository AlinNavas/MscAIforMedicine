...
csv_logger = CSVLogger('./logs/InceptionV3_r2_training.csv')
# Define the checkpoint callback
checkpoint = ModelCheckpoint(filepath='./model_weights/InceptionV3_r2_model_weights.h5', 
                             monitor='val_loss', 
                             save_best_only=True,
...
plt.legend()
plt.show()
plt.savefig('./img/InceptionV3_r2_loss_plot.png')
...
plt.legend()
plt.show()
plt.savefig('./img/InceptionV3_r2_accuracy_plot.png')
...
plt.show()
plt.savefig('./img/InceptionV3_r2_confusion_matrix.png')
# Print the F1 score
print('F1 Score:', f1)
