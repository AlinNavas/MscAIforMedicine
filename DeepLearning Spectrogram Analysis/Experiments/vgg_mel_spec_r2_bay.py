...
def objective(trial):
    ...
    layer_size_1 = trial.suggest_int('layer_size', 10, 4098) ######## modify the range
    layer_size_2 = trial.suggest_int('layer_size', 10, 4098) ######## modify the range
    layer_size_3 = trial.suggest_int('layer_size', 10, 4098) ######## modify the range
...
save_path = './opt_study/optuna_vgg_mel_spec_r2_bay_study.pkl'
